...
namespace Sirius\Redis\Abstracts;

use Closure;
use Sirius\Redis\Limiters\DurationLimiterBuilder;
use Sirius\Redis\Limiters\ConcurrencyLimiterBuilder;
...
abstract class Connection
{
     ...
     * @param  string  $name
     *
     * @return \Sirius\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     * @param  string  $name
     *
     * @return \Sirius\Redis\Limiters\DurationLimiterBuilder
     */
